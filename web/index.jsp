<%-- 
    Document   : index
    Created on : 18 févr. 2021, 10:04:33
    Author     : ZALO
--%>
...
<html>
    ...
    <body>
        ...
        <ol>
            <li><a href="ServletUsers?action=creerUtilisateursDeTest">Créer quatre(4) utilisateurs de test</a></li>

            <li>Créer un utilisateur</li>
            <form action="ServletUsers" method="get">
                Nom : <input type="text" name="nom"/><br>
                Prénoms : <input type="text" name="prenom"/><br>
